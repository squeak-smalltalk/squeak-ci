...
wget -O "$WORKSPACE/target/Squeak-4.10.2.2614-linux_x86_64.sh" http://www.squeakvm.org/unix/release/Squeak-4.10.2.2614-linux_x86_64.sh
chmod +x "$WORKSPACE/target/Squeak-4.10.2.2614-linux_x86_64.sh"
mkdir -p "$WORKSPACE/target/linux-stackvm"
"$WORKSPACE/target/Squeak-4.10.2.2614-linux_x86_64.sh" -prefix="$WORKSPACE/target/linux-stackvm"
